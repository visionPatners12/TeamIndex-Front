...
exports.syncClobFillsAndSettle = syncClobFillsAndSettle;
...
async function syncClobFillsAndSettle(env) {
    ...
    for (const pos of openPositions) {
        ...
        if (pos.clobOrderId) {
            try {
                const order = await (0, clobClient_1.getOrder)(env, pos.clobOrderId);
        ...
        const midRaw = await (0, clobClient_1.getMidpoint)(env, pos.tokenId).catch(() => "0");
