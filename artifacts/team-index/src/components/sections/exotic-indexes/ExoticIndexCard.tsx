  ...
  >
    ...
    <div className="flex gap-3 w-full mt-auto">
      <div className="flex-1 bg-[#1a1710] rounded-xl px-3 py-2.5 flex flex-col items-start border border-[#2a2720]">
        <span className="font-jura text-[10px] font-bold text-white/35 uppercase tracking-wider mb-1">Token Value</span>
        <span className="text-white/30 text-sm font-bold font-mono">--</span>
      </div>
      <div className="flex-1 bg-[#1a1710] rounded-xl px-3 py-2.5 flex flex-col items-start border border-[#2a2720]">
        <span className="font-jura text-[10px] font-bold text-white/35 uppercase tracking-wider mb-1">Holders</span>
        <span className="text-white/30 text-sm font-bold font-mono">--</span>
      </div>
    </div>
