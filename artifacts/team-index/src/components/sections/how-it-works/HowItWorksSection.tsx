...
export const HowItWorksSection: React.FC = () => (
  <section
    className="w-full flex flex-col items-center py-20 px-4 sm:px-10 lg:px-[120px] gap-16"
    style={{
      background:
  ...
  >
    <GradientHeading
      as="h2"
      className="text-[38px] sm:text-[52px] lg:text-[63px] leading-[108%] text-center"
      style={{ letterSpacing: "0.8px" }}
    >
      HOW TEAM INDEX WORKS
    </GradientHeading>
    <div className="relative flex flex-col md:flex-row gap-10 md:gap-[60px] w-full max-w-7xl items-stretch">
      {/* Dashed connector line with gradient color */}
      <div
        className="hidden md:block absolute left-0 right-0 top-6 h-px z-0"
        style={{
