...
export const VaultArchitectureSection: React.FC = () => (
  <section className="w-full py-20 px-4 sm:px-10 lg:px-30 bg-[#0D0A06]">
    <div className="w-full flex flex-col items-center gap-8 text-center">
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-6 lg:gap-4 mt-4 items-start">
        ...
        {/* ── CENTER DIVIDER ── */}
        <div className="hidden lg:flex flex-col items-center justify-center self-center gap-3 px-2">
          <div className="w-px h-16 bg-gradient-to-b from-transparent via-[#FEB413]/30 to-transparent" />
          <span className="font-jura font-bold text-xs text-[#FEB413]/60 uppercase tracking-widest writing-vertical">or</span>
          <div className="w-px h-16 bg-gradient-to-b from-transparent via-[#FEB413]/30 to-transparent" />
        </div>

        <div className="flex lg:hidden items-center justify-center gap-4 py-2">
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#FEB413]/20 to-transparent" />
          <span className="font-jura font-bold text-sm text-[#FEB413]/60 uppercase">or</span>
          <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#FEB413]/20 to-transparent" />
        </div>
